...
let BotService = BotService_1 = class BotService {
    ...
    async handleShareProfile(ctx) {
        ...
        try {
            ...
            await ctx.reply(`🔗 **Поделиться профилем**\n\n` +
    ...
    // =====================================
    async handlePublicProfileView(ctx) {
    ...
    async handlePlayWithPlayer(ctx) {
    ...
    async handleSendMatchInvite(ctx) {
        ...
        try {
            ...
            await ctx.reply(`✅ Приглашение отправлено!\n\nПользователь получит уведомление о вашем приглашении на матч.`, telegraf_1.Markup.inlineKeyboard([
    ...
    async handleReportSubmit(ctx) {
        ...
        try {
            ...
            const reportText = reportTypes[reportType] || 'Неизвестная причина';
            await ctx.reply(`⚠️ **Жалоба отправлена**\n\nПричина: ${reportText}\n\nВаша жалоба будет рассмотрена администраторами.`, telegraf_1.Markup.inlineKeyboard([
                [telegraf_1.Markup.button.callback('🔙 Назад к профилю', `public_profile_${targetUserId}`)]
            ]));
...
__decorate([
    (0, nestjs_telegraf_1.Action)('toggle_notifications'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [telegraf_1.Context]),
    __metadata("design:returntype", Promise)
], BotService.prototype, "handleToggleNotifications", null);
__decorate([
    (0, nestjs_telegraf_1.Action)('lang_ru'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [telegraf_1.Context]),
    __metadata("design:returntype", Promise)
], BotService.prototype, "handleLangRu", null);
__decorate([
    (0, nestjs_telegraf_1.Action)('lang_en'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [telegraf_1.Context]),
    __metadata("design:returntype", Promise)
], BotService.prototype, "handleLangEn", null);
__decorate([
    (0, nestjs_telegraf_1.Action)('back_to_menu'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [telegraf_1.Context]),
    __metadata("design:returntype", Promise)
], BotService.prototype, "handleBackToMenu", null);
__decorate([
    (0, nestjs_telegraf_1.Action)('edit_profile'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [telegraf_1.Context]),
    __metadata("design:returntype", Promise)
], BotService.prototype, "handleEditProfile", null);
__decorate([
...
__decorate([
    (0, nestjs_telegraf_1.Action)('rating'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [telegraf_1.Context]),
    __metadata("design:returntype", Promise)
], BotService.prototype, "handleRating", null);
__decorate([
    (0, nestjs_telegraf_1.Action)('share_profile'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [telegraf_1.Context]),
    __metadata("design:returntype", Promise)
], BotService.prototype, "handleShareProfile", null);
__decorate([
    (0, nestjs_telegraf_1.Action)(/^public_profile_(\d+)$/),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [telegraf_1.Context]),
    __metadata("design:returntype", Promise)
], BotService.prototype, "handlePublicProfileView", null);
__decorate([
    (0, nestjs_telegraf_1.Action)(/^play_with_(\d+)$/),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [telegraf_1.Context]),
    __metadata("design:returntype", Promise)
], BotService.prototype, "handlePlayWithPlayer", null);
__decorate([
    (0, nestjs_telegraf_1.Action)(/^message_(\d+)$/),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [telegraf_1.Context]),
    __metadata("design:returntype", Promise)
], BotService.prototype, "handleMessagePlayer", null);
__decorate([
    (0, nestjs_telegraf_1.Action)(/^report_(\d+)$/),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [telegraf_1.Context]),
    __metadata("design:returntype", Promise)
], BotService.prototype, "handleReportPlayer", null);
__decorate([
    (0, nestjs_telegraf_1.Action)(/^send_match_invite_(\d+)$/),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [telegraf_1.Context]),
    __metadata("design:returntype", Promise)
], BotService.prototype, "handleSendMatchInvite", null);
__decorate([
    (0, nestjs_telegraf_1.Action)(/^report_(\w+)_(\d+)$/),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [telegraf_1.Context]),
    __metadata("design:returntype", Promise)
], BotService.prototype, "handleReportSubmit", null);
