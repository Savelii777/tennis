...
exports.Prisma.PlayerRatingScalarFieldEnum = makeEnum({
  id: 'id',
  userId: 'userId',
...
exports.Prisma.RatingHistoryScalarFieldEnum = makeEnum({
  id: 'id',
  userId: 'userId',
  matchId: 'matchId',
  seasonId: 'seasonId',
...
exports.Prisma.RatingSeasonScalarFieldEnum = makeEnum({
  id: 'id',
  title: 'title',
  startDate: 'startDate',
  endDate: 'endDate',
...
exports.Prisma.UserAchievementScalarFieldEnum = makeEnum({
  id: 'id',
  userId: 'userId',
  code: 'code',
  awardedAt: 'awardedAt',
...
exports.Prisma.UserStateScalarFieldEnum = makeEnum({
  id: 'id',
  userId: 'userId',
  step: 'step',
  data: 'data',
